const Info = {
  ...
  profile: {
    ...
    about: [
      ...
      "Mr Abrar's aim is to ensure peace and justice in his community and on the global stage with the diverse experience he gained on national and international levels. Having received 4 overseas scholarships within a span of 6 months, actively engaged in various ECAs for 3 years and maintained academic excellence, his primary objective using this platform is to mentor and assist students through 1-to-1 consultancy in these respective fields voluntarily.",
    ],
    picture: 'me.jpg',
    services: [
      'Overseas Admission Application Guideline and Review.',
      'Scholarship Application Guideline and Review.',
      'ECA suggestions (based on your area of interest).',
      'Interdisciplinary and Cross-disciplinary Research Collaboration.',
      'CV and Resume Review.',
      'Academic Guidance and Assistance (For Law Students Only).',
    ],
  },
  contact: {
  ...
  certification: [
    {
      ...
      // titleLink: 'https://www.osun.org/',
      description: 'South Asian Institution for Social Transformation.',
      // year: '2021', // optional
      // link: 'https://www.osun.org/', // optional
      // linkText: 'Link', // optional
    },
    ...
    },
    {
      ...
      description: 'South Asian Institute for Social Transformation.',
    },
    {
      title: 'Corporate and Commercial Contract',
