  ...
  return (
    <li>
      <NavLink onClick={props.onClick} to={props.to}>
        <span className={`${border} w-full flex items-center text-gray-700 md:text-gray-200 hover:text-gray-500 md:hover:text-gray-400 text-center font-semibold`}>{props.text}</span>
